...
class Osm2PovConverter {
	...
	void drawWay(const vector<const class Node*> *nodes, double width, double height, const char *style);
	...
	void drawWays(const char *key, const char *value, double width, double height, const char *style);
